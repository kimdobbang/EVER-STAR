...
- API - OpenaiAPI - NAVER Cloud CLOVA SentimentAPI - Firebase API - Cool Sms - S3 - kakao OAuth - google OAuth
</aside>
...
- **[Back - auth server] Jenkins 파이프라인**
  ...
  pipeline {
      ...
      environment {
          ...
          DB_PASSWORD = '' // 자격 증명에서 비밀번호를 가져옵니다.
          JWT_SECRET = '' // 자격 증명에서 JWT 비밀 키를 가져옵니다.
          JWT_ACCESS_TOKEN_EXPIRE = '144000000'
          SMS_API_KEY = ''
          SMS_API_SECRET = ''
          SMS_PROVIDER = ''
